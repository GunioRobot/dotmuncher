...
s.set(VISIBLE_TO_OBSERVER | PLAYER_ALIVE | PLAYER_FROZEN);
console.log(s.is(VISIBLE_TO_OBSERVER | PLAYER_ALIVE | PLAYER_FROZEN));

s.unset(VISIBLE_TO_OBSERVER | PLAYER_ALIVE | PLAYER_FROZEN);
console.log(s.is(VISIBLE_TO_OBSERVER | PLAYER_ALIVE | PLAYER_FROZEN));
